...
export class Department extends Component {
    ...
    refreshList()
    {
        fetch(variabels.API_URL+'/departments').then(response=>response.json())
        .then(data=>
            {
    ...
    createClick(){
        fetch(variabels.API_URL+'/departments',{
            ...
            .then(res=>res.json())
            .then(result=>{
                alert(`department ${result.departmentName} created sucessfully.`);
                this.refreshList();
            },(error)=>{
                alert("failed");
            })
    ...
    updateClick(){
        fetch(variabels.API_URL+'/departments/'+this.state.departmentId,{
            method:'PUT',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json'
    ...
    deleteClick(departmentId){
        ...
        fetch(variabels.API_URL+'/departments/'+departmentId,{
            method:'DELETE',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json'
    ...
    render() {
        ...
        return(
            ...
            <div>
               ...
               <table className="table table-stariped">
                   <thead>
                        <tr>
                            <th>
                                DepartmentId
                           ...
                           departments.map(department=>
                            <tr key={department.departmentId}>
                                ...
                                <td>
                                    ...
                                    <button type="button" className="btn btn-light mr-1" onClick={()=>this.deleteClick(department.departmentId)}>
